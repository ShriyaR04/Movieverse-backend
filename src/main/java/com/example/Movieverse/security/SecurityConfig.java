package com.example.Movieverse.security;

import com.example.Movieverse.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/user/**").hasAuthority("ROLE_USER")// allow signup/login
